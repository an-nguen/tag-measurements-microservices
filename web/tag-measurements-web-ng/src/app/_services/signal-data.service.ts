...
export class SignalDataService {
  ...
  getSignalDataByUUID(uuidList: string[], startDate: any, endDate: any, epsilon: number) {
    ...
    return this.httpClient.get<Measurement[]>(environment.gateway + '/api/signalTagData',
        {params: params}
    );
  }
}
